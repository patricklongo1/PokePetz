  ...
  return (
    <>
      ...
      <S.Content>
        ...
        <S.SubTitle>Como funciona a cura de um pokémon?</S.SubTitle>
        <S.Text>
        ...
        <S.SubTitle>Uma tradição de mais de 20 anos</S.SubTitle>
        <S.Text>
        ...
        <S.SubTitle>O melhor para seu pokémon</S.SubTitle>
        <S.Text>
        ...
        <S.SubTitle>Alta Tecnologia</S.SubTitle>
        <S.Text>
